...
pygame.display.set_caption(nyelv.caption + random.choice(nyelv.captions))
...
while run:
                ...
                if vars["performance"] == 1:
                    ...
                    if vars["settings"] == 1:
                        ...
                        if onf(sw-180,385,50,50, mousepos):
                            print("heart")
                            vars["developer ui"] *= -1
                        if onf(sw-180,440,50,50, mousepos):
                            print("exit")
                            vars["leaving"] *= -1
                        ...
                        if onf(sw-125,275,50,50, mousepos):
                            ...
                            if vars["example"] == 0:
                                ...
                                példák.pl4(spinners,spinner)
                            elif vars["example"] == 4:
                                példák.pl5(spinners,spinner)
                            elif vars["example"] == 5:
                                példák.pl6(spinners,spinner)
                            elif vars["example"] == 6:
                                példák.pl7(spinners,spinner)
                            elif vars["example"] == 7:
                                példák.pl8(spinners,spinner)
                            elif vars["example"] == 8:
                                példák.pl9(spinners,spinner)
                            elif vars["example"] == 9:
                                példák.pl10(spinners,spinner)
                        ...
                        if onf(sw-125,385,50,50, mousepos):
                            ...
                            vars["background color change"] *= -1
                    ...
                    if vars["background color change"] == 1:
                        if onf(280,135,50,50, mousepos):
                            print("fel piros")
                            vars["delta color"][0] = 1                         
                        if onf(280,190,50,50, mousepos):
                            print("le piros")
                            vars["delta color"][0] = -1                          
                        if onf(335,135,50,50, mousepos):
                            print("fel zöld")
                            vars["delta color"][1] = 1                          
                        if onf(335,190,50,50, mousepos):
                            print("le zöld")
                            vars["delta color"][1] = -1                          
                        if onf(390,135,50,50, mousepos):
                            print("fel kék")
                            vars["delta color"][2] = 1    
                        if onf(390,190,50,50, mousepos):
                            print("le kék")
                            vars["delta color"][2] = -1
                        if onf(390,290,50,50, mousepos):
                            print("ok")
                            vars["background color change"] = -1
    ...
    if vars["performance"] == 1 and vars["background color change"] == 1:
        for i in range(3):
            vars["background color"][i] += vars["delta color"][i]
            vars["background color"][i] %= 256
    ...
    #background
    overlay.fill((*vars["background color"], vars['opacity']))
    ...
    if vars["performance"] == 1:
        if vars["developer ui"] == 1:
            ...
            screen.blit(font.render(";)",True,(0,0,0)),(52, sh-60))

        if vars["background color change"] == 1:
            pygame.draw.rect(screen,(200,200,200),(50,50,400,300))
            pygame.draw.rect(screen,(0,0,0),(50,50,400,300),5)

            pygame.draw.rect(screen,vars["background color"],(60,60,200,200))
            pygame.draw.rect(screen,(0,0,0),(60,60,200,200),5)

            screen.blit(images["red"],(280,60))
            screen.blit(images["increase"],(280,135))
            screen.blit(images["decrease"],(280,190))
            
            screen.blit(images["green"],(335,60))
            screen.blit(images["increase"],(335,135))
            screen.blit(images["decrease"],(335,190))
            
            screen.blit(images["blue"],(390,60))
            screen.blit(images["increase"],(390,135))
            screen.blit(images["decrease"],(390,190))

            screen.blit(font.render(f"{', '.join(map(str,vars['background color']))}",True,(0,0,0)),(100,285))
            
            pygame.draw.rect(screen,(0,0,0),(390,290,50,50),5)
            screen.blit(font.render("OK",True,(0,0,0)),(400,305))
        ...
        if  vars["show frames"] == 1:
            ...
            if vars["settings"] == 1:
                pygame.draw.rect(screen,(200,200,200),(sw-190,100,125,400))
                pygame.draw.rect(screen,(0,0,0),(sw-190,100,125,400),5)
        ...
        if vars["settings"] == 1:
            ...
            screen.blit(images["exit"], (sw-180,440))
            ...
            screen.blit(images["background"], (sw-125,385))
