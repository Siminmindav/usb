...
class spinner:
    def __init__(self,ox, oy, ow, oh, x, y, w, h, color, angle, omega,r, shapes=[1,0,0,1], clockmax=0, functions=[]):
        self.move = 0
        self.clock = 0
        self.clockmax = clockmax
        self.functions = functions
        self.shapes = shapes # rect, circle, line. middle rect
        self.r = r
        self.ox = ox
        self.oy = oy
        self.ow = ow
