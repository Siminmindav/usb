...
captions = [
    "Видеоигра",
    "В этой игре что-то спрятано, найди это!",
    "Закрой глаза и сыграй в игру! ...или не закрывай глаза и сыграй в игру!",
    "'Pygame не отстой, ты отстой!' Искусство войны - Сунь-цзы",
    "Ты можешь делать здесь что угодно. (теоретически)",
    "Эта игра не имеет цели, но если хочешь, можешь найти её.",
    "¯\\_(ツ)_/¯",
    "Всё круто!",
    ":/",
    "♥♥♥",
    "Триангуляция!",
    "Siminmindav Infók és weboldalak (У меня есть свой собственный веб-сайт :D)",
]
