...
captions = [
    "Videójáték",
    "Valami el van rejtve ebben a játékban, találd meg!",
    "Csukd be a szemed, és játszál egy játékot!  ...vagy ne csukd be a szemed, és játszál egy játékot!",
    "'Pygame nem nívótlan, te vagy az!' A háború művészete - Sun Tzu", 
    "Itt bármit tehetsz. (elméletileg)",
    "Ez a játék nem tartalmaz semmilyen célt, de ha szeretnél, találhatsz egyet.",
    "¯\\_(ツ)_/¯",
    "Minden szipi-szuper!",
    ":/",
    "♥♥♥",
    "kumisz",
    "Siminmindav Infók és weboldalak (Van saját weboldalam :D)",
